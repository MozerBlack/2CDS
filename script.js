...
const menuHomeLink = document.getElementById('menu-home'); // Adicionado o Home
...
// Seletores para Notícias (NOVOS/ATUALIZADOS)
...
    // Removei configuracoesPage, pois a div não existia no HTML fornecido, 
    // mas deixei a variável para referência futura.
    noticiasPage.classList.add('hidden-content'); // Esconde Notícias
}
...
// --- 5. Lógica de Navegação entre Home, Alunos e Notícias ---

// Link 'Home'
if (menuHomeLink) {
    menuHomeLink.addEventListener('click', (event) => {
        event.preventDefault();
        showHomePage(VALID_USERNAME); 
    });
}
